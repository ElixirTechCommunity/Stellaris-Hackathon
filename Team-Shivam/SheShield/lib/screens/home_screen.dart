...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  /// Current risk assessment result — updated when location is fetched.
  ...
  /// Start a 5-second countdown — triggers SOS if not cancelled.
  ...
  Future<void> _navigateToSafeZone() async {
  ...
  Widget _buildRiskAlertCard(bool isDark) {
    ...
    // ── Determine colours & icons based on risk level ──
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 2),
                            Text(
                              '${risk.nearestSafeZone!.name} • ${risk.nearestSafeZone!.type}',
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w600,
                                color: isDark
              ...
              // ── Demo toggle: simulate isolated area ──
              const SizedBox(height: 10),
              Container(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              '⚠️ Auto SOS in $_autoSosCountdown seconds',
                              style: const TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w700,
                                color: Color(0xFFE53935),
              ...
              // ── Action buttons (SOS + Navigate) when risk detected ──
