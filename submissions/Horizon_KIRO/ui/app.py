...
class JarvisGUIApp:
    ...
    def __init__(self, enable_voice: bool = False):
        ...
        self.chat_card = None  # Will be created on demand
    ...
    def show_chat_card(self):
        """Show the chat card dialog - create fresh instance each time"""
        ...
        if self.chat_card is not None:
            try:
                self.chat_card.reject()
            except:
                pass
        
        # Create a fresh ChatCard instance
